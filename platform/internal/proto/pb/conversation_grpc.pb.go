...
const (
	...
	ConversationService_AddUserToConversation_FullMethodName          = "/pb.ConversationService/AddUserToConversation"
	ConversationService_GetPublicConversations_FullMethodName         = "/pb.ConversationService/GetPublicConversations"
	ConversationService_GetPrivateConversationsForUser_FullMethodName = "/pb.ConversationService/GetPrivateConversationsForUser"
	ConversationService_CreateMessage_FullMethodName                  = "/pb.ConversationService/CreateMessage"
	ConversationService_ChatStream_FullMethodName                     = "/pb.ConversationService/ChatStream"
)
...
func (c *conversationServiceClient) AddUserToConversation(ctx context.Context, in *ConversationHasParticipant, opts ...grpc.CallOption) (*Conversation, error) {
	out := new(Conversation)
	err := c.cc.Invoke(ctx, ConversationService_AddUserToConversation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationServiceClient) GetPublicConversations(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConversationList, error) {
	...
	err := c.cc.Invoke(ctx, ConversationService_GetPublicConversations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationServiceClient) GetPrivateConversationsForUser(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*ConversationList, error) {
	out := new(ConversationList)
	err := c.cc.Invoke(ctx, ConversationService_GetPrivateConversationsForUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationServiceClient) CreateMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, ConversationService_CreateMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationServiceClient) ChatStream(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (ConversationService_ChatStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ConversationService_ServiceDesc.Streams[0], ConversationService_ChatStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _ConversationService_AddUserToConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationService_AddUserToConversation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConversationService_GetPublicConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationService_GetPublicConversations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConversationService_GetPrivateConversationsForUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationService_GetPrivateConversationsForUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
